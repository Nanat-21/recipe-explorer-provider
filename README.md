...
A Flutter application built using Provider for state management and HTTP for networking, integrated with TheMealDB API. This app focuses on simplicity, fast development, and reactive UI updates using Provider’s lightweight architecture.
...
![alt text](<screenshots/Screenshot 2026-05-18 184951.png>)
![alt text](<screenshots/Screenshot 2026-05-18 185005.png>)
![alt text](<screenshots/Screenshot 2026-05-18 185048.png>)
![alt text](<screenshots/Screenshot 2026-05-18 185111.png>)
![alt text](<screenshots/Screenshot 2026-05-18 193736.png>)
...
![alt text](<screenshots/Screenshot 2026-05-18 185136.png>)
...
![alt text](<screenshots/Screenshot 2026-05-18 185242.png>)
![alt text](<screenshots/Screenshot 2026-05-18 185315.png>)

⚙️ Settings & Configuration
The Settings screen provides app-specific information and allows users to manage their preferences.

![alt text](<screenshots/Screenshot 2026-05-18 185303.png>)

📁 Project Structure

The app uses a feature-based folder structure for clarity and scalability.
